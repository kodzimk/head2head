      ...
      <main className="flex-1 ">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-center">
            ...
            <h1 className="text-5xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-orange-300   leading-tight">
              Battle Your Sports Knowledge 
              <br />
              <span className="text-orange-300">in Real-Time</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-orange-100/90 max-w-xl leading-relaxed mt-6">
              Challenge friends and players worldwide in real-time sports trivia battles. Prove you're the ultimate sports fan!
            </p>
            <Button className="mt-8 bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 text-lg font-semibold rounded-lg">
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-full max-w-3xl px-4">
              <div className="grid grid-cols-3 gap-6">
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-2xl font-bold text-orange-300">10M+</div>
        ...
        <section id="battles" className="w-full py-8 relative scroll-mt-16 overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Features and Services</h2>
            ...
            <div className="flex flex-col gap-8 max-h-8xl max-w-6xl mx-auto">
              {[
                ...
                <Card
                  key={mode.name}
                  className={`flex flex-col ${idx % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} bg-white border border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 rounded-xl overflow-hidden h-full`}
                >
                  ...
                  <CardContent
                    className={`pt-4 w-full md:w-1/2 flex flex-col ${idx % 2 === 1 ? 'items-end text-right' : 'items-start text-left'}`}
                  >
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">{mode.name}</h3>
                    <p className="text-gray-600 mb-4 w-full md:w-2/3">{mode.desc}</p>
                    <Button className="w-full md:w-1/2 bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 text-lg font-semibold rounded-lg" >
                      <Play className="w-5 h-5 mr-2" />
                      Start Playing
                    </Button>
                  </CardContent>
        ...
        <section
          id="sports"
          className="w-full py-24 scroll-mt-16 relative"
          style={{
        ...
        >
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white mb-4">All Your Favorite Sports</h2>
            ...
            <div className="grid gap-6 grid-cols-2 md:grid-cols-4 max-w-5xl mx-auto">
              {[
                ...
                <Card
                  key={sport.name}
                  className="bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer relative hover:scale-105 group"
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-orange-100/70">{sport.battles} battles</p>
                  </CardContent>
                </Card>
              ))}
            </div>
