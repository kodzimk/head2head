...
const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-transparent rounded-2xl overflow-hidden">
        {/* Coming Soon Overlay */}
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-center p-4 sm:p-6">
